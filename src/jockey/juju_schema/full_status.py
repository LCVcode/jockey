...
ApplicationOfferStatus = TypedDict(
    "ApplicationOfferStatus",
    {
        # | Required property
...
RemoteApplicationStatus = TypedDict(
    "RemoteApplicationStatus",
    {
        # | Required property
